          ...
          <table>
            <thead>
              <tr className="text-[14px] text-foreground-700 bg-neutral-100">
                ...
                <th className="border-1 border-foreground-200">수량</th>
                <th className="border-1 border-foreground-200">삭제하기</th>
              </tr>
            </thead>
            <tbody>
              {temp.map((item) => (
                ...
                >
                  ...
                  <td className="text-center border-r-1 border-foreground-200">654400681</td>
                  <td className="text-center pl-2 border-r-1 border-foreground-200 py-2">
                    테타불린에스앤주PFS
                  </td>
                  <td className="text-center pl-2 border-r-1 border-foreground-200 py-2">
                  ...
                  <td className="text-center border-r-1 border-foreground-200">1ml / 1관</td>
                  <td className="pr-2 border-r-1 border-foreground-200 text-end">106,000원</td>
                  <td className="text-center border-r-1 border-foreground-200">10</td>
                  <td className="pl-2">
                    <Trash className="w-4 h-4 text-danger-500 cursor-pointer mx-auto" />
                  </td>
                </tr>
              ))}
            </tbody>
