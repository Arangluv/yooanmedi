...
import { PaymentRequestDtos } from './payment.request.fixture';
...
export const PaymentFixtures = {
  ...
  request: {
    zeroUsedPoint: {
      bank: PaymentRequestDtos.zeroUsedPoint.bank(),
      pg: PaymentRequestDtos.zeroUsedPoint.pg(),
    },

    usePoint: {
      bank: PaymentRequestDtos.usePoint.bank(),
      pg: PaymentRequestDtos.usePoint.pg(),
    },

    zeroTotalAmonut: {
      bank: PaymentRequestDtos.zeroTotalAmount.bank(),
      pg: PaymentRequestDtos.zeroTotalAmount.pg(),
    },
  },
};
