...
const orderListSearchBaseSchema = z.object({
  from: z.string(),
  to: z.string(),
  pn_keyword: z.string(),
...
export const orderListSearchSchema = orderListSearchBaseSchema.transform((data) => ({
...
export type OrderListDto = z.infer<typeof orderListSearchSchema>;
