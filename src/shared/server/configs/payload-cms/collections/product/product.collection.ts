...
export const product: CollectionConfig = {
  ...
  admin: {
    ...
    components: {
      beforeListTable: [
        '@/shared/server/configs/payload-cms/components/product/ProductBulkUploadButton',
      ] as CustomComponent[],
    },
  },
  fields: [
    ...
    },
    {
      ...
      admin: {
        ...
        components: {
          Cell: '@/shared/server/configs/payload-cms/components/common/cells/BestProductCell',
