...
export const pgCno = stringSchema({
  required_message: 'PG 주문번호는 비어있을 수 없습니다.',
  invalid_message: '유효하지 않은 PG 주문번호입니다.',
  length: 20,
});

export const approvalReqDate = stringSchema({
...
export const orderNo = stringSchema({
  required_message: '주문 번호는 비어있을 수 없습니다.',
  invalid_message: '유효하지 않은 주문 번호입니다.',
  length: 15,
});

export const orderListJson = stringSchema({
